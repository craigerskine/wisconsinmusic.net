<template>
  <nav :class="paginateCss">
    <ul class="text-lg flex flex-wrap items-center justify-center space-x-5">
      <li v-if="pageCurrent > 2"><nuxt-link :to="paginatePath +'page/'+ pagePrev +'/'" class="transition hover:(text-white) focus:(text-white)"><span class="sr-only">Previous</span> <i class="fa-light fa-fw fa-angle-left"></i></nuxt-link></li>
      <li v-else-if="pageCurrent === 2"><nuxt-link :to="paginatePath" class="transition hover:(text-white) focus:(text-white)"><span class="sr-only">Previous</span> <i class="fa-light fa-fw fa-angle-left"></i></nuxt-link></li>
      ...
      <li v-if="pageCurrent !== pagesTotal"><nuxt-link :to="paginatePath +'page/'+ pageNext +'/'" class="transition hover:(text-white) focus:(text-white)"><span class="sr-only">Next</span> <i class="fa-light fa-fw fa-angle-right"></i></nuxt-link></li>
