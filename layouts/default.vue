<template>
  <div class="page min-h-screen flex flex-col">
    <header class="py-8 flex-1 flex items-center justify-center space-x-6">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" role="img" fill="none" class="w-[8vw] h-auto text-white opacity-50 stroke-current">
      ...
      <h1 class="text-white text-[6vw] font-thin uppercase"><b class="font-black">Wisconsin</b> Music</h1>
    </header>
    <main class="flex-1 text-center">
      <p class="md:text-[2vw]">New site coming soon!</p>
    </main>
    <footer class="mt-auto py-8 px-4 text-xs text-center font-bold uppercase">
